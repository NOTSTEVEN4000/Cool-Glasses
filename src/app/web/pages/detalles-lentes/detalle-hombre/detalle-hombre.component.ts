...
@Component({
  selector: 'app-detalle-hombre',
  standalone: true,
  imports: [NgClass, NgFor, NgIf, NgStyle, NavBarComponent, FooterComponent,AngularxQrcodeStandaloneModule],
  templateUrl: './detalle-hombre.component.html',
  styleUrls: ['./detalle-hombre.component.css']
})
export class DetalleHombreComponent implements OnInit {
  mainImage!: string;
  thumbnails!: string[];
  quantity: number = 1;
