...
@Component({
  selector: 'app-detalle-ninos',
  standalone: true,
  imports: [NgClass, NgFor, NgIf, NgStyle, NavBarComponent, FooterComponent,AngularxQrcodeStandaloneModule],
  templateUrl: './detalle-ninos.component.html',
  styleUrls: ['./detalle-ninos.component.css']
})
export class DetalleNinosComponent implements OnInit {
  mainImage!: string;
  thumbnails!: string[];
  quantity: number = 1;
