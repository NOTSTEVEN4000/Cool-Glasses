...
@Component({
  selector: 'app-page-buscador-producto',
  standalone: true,
  imports: [FormsModule, CommonModule, NavBarComponent, FooterComponent,AngularxQrcodeStandaloneModule],
  templateUrl: './page-buscador-producto.component.html',
  styleUrl: './page-buscador-producto.component.css'
})
export class PageBuscadorProductoComponent implements OnInit {
  producto!: Producto;
  quantity: number = 1;
  mainImage!: string;
  thumbnails!: string[];
